...
def runModeFour():
    ...
    while running:
        ...
        mousepos1 = (mousepos[0] - mouserot.get_rect().width/2,
                     mousepos[1] - mouserot.get_rect().height/2)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                position = pygame.mouse.get_pos()
                acc[1] += 1
                arrows.append([math.atan2(position[1] - (mousepos1[1] + 32), position[0] - (
                    mousepos1[0] + 26)), mousepos1[0] + 32, mousepos1[1] + 32])
    ...
    if exitcode == 0:
        ...
        text = font.render(
            "Ban thua roi, meo đa pha huy thanh cong o chuot, Ban se la bua toi cua bay meo", True, (0, 255, 0))
        ...
        font = pygame.font.Font(None, 28)
        text = font.render(
            "Ban thang, Bon meo da phai roi di", True, (0, 0, 255))
        textRect = text.get_rect()
        textRect.centerx = screen.get_rect().centerx
        textRect.centery = screen.get_rect().centery + 24
